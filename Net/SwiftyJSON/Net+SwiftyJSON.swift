...
public protocol SwiftyJSONProtocol {
    ...
    init(_ json:JSON, tag:SwiftyJSONTag?)
    
}

public protocol SwiftyJSONTag { }


public extension Net {
    @discardableResult
    func mapModels<J:SwiftyJSONProtocol>(withSwiftyJSON t:J.Type, tag:SwiftyJSONTag? = nil, succeed:(([J]) ->Void)?) -> Self {
        success = { res in
    ...
    @discardableResult
    func mapModel<J:SwiftyJSONProtocol>(withSwiftyJSON t:J.Type, tag:SwiftyJSONTag? = nil, succeed:((J) ->Void)?) -> Self {
        success = { res in
            let json = JSON(res)
...
public extension Data {
    func mapSwiftJSONModel<J:SwiftyJSONProtocol>(_ t:J.Type, tag:SwiftyJSONTag? = nil) -> J {
        let json = JSON(self)
        return J(json, tag: tag)
    }
    func mapSwiftJSONModels<J:SwiftyJSONProtocol>(_ t:J.Type, tag:SwiftyJSONTag? = nil) -> [J] {
